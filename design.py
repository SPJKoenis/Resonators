...
class Transmission_Line:
	...
	def Generate(self, coords, rots, start = 'horizontal', right = False): 
		...
		return gdspy.boolean(gdspy.boolean(Line_With_Turns(coords, rots, self.d, self.d2, start = start, right = right), 
										   Line_With_Turns(coords, rots, self.d, self.d1, start = start, right = right), 'not'),
							Line_With_Turns(coords, rots, self.d, self.d, start = start, right = right), 'or',
							layer = self.layer) 
